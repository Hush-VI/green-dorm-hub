  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 space-y-3">
        {isLoading && <div className="py-10 text-center text-sm text-muted-foreground">Loading policies…</div>}
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 space-y-3">
        {POLICY_SECTIONS.map((s, i) => (
          <div key={i} className="rounded-2xl bg-white shadow-soft ring-1 ring-border/40 overflow-hidden">
            <div className="flex items-start gap-4 px-5 py-4">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-primary/10 text-xs font-bold text-primary mt-0.5">
                {i + 1}
              </div>
